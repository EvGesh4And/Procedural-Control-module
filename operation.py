...
class Operation(QWidget):
    ...
    def initUi(self):
        ...
        self.equally_label.setAlignment(QtCore.Qt.AlignCenter)
        self.equally_label_font = QFont('Times', 14)
        self.equally_label.setFont(self.equally_label_font)
        self.table.setCellWidget(0, 1, self.equally_label)
        ...
        self.add_condition = self.contextMenu.addAction("Добавить операцию")
        self.delete_condition = self.contextMenu.addAction("Удалить выбранную операцию")
        ...
        if (self.click_value.y() < 50 and (self.click_value.x() < 160 or self.click_value.x() > 187)):
            if (self.is_moveable):
                if (self.parent != None):
                    ...
                    self.move(self.move_x, self.move_y)
                    self.parent.parent.scroll.ensureVisible(self.move_x + self.width(), self.move_y + self.height(), 0,
                                                            20)
    ...
    def added_condition(self):
        ...
        q2 = QLabel('=')
        q2.setAlignment(QtCore.Qt.AlignCenter)
        q2_font = QFont('Times', 14)
        q2.setFont(q2_font)
    ...
    def deleted_block(self):
        ...
        self.reply = QMessageBox.question(
            self, "Удаление",
            "Вы действительно хотите удалить блок операций?",
